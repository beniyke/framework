 ...
 * Anchor Framework
 *
 * Inflector provides a flexible and extensible way to pluralize and singularize English words.
 *
...
class Inflector
{
     ...
     *
     * @return bool|string Inflected value on cache hit or false on cache miss.
     */
     ...
     * ```
     *
     * @param $type string [The type of inflection, either 'plural', 'singular']
     */
